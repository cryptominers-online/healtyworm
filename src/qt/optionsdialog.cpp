        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start HealthyWormCoin on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start HealthyWormCoin after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the HealthyWormCoin client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show HealthyWormCoin addresses in the transaction list"));
