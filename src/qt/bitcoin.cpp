 ...
 * 2016-2017 The HealthyWormCoin developers
 */
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. HealthyWormCoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    {
        if (strlen(argv[i]) >= 7 && strncasecmp(argv[i], "HealthyWormCoin:", 7) == 0)
        {
    ...
    app.setOrganizationName("HealthyWormCoin");
    app.setOrganizationDomain("HealthyWormCoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("HealthyWormCoin-Qt-testnet");
    else
        app.setApplicationName("HealthyWormCoin-Qt");
