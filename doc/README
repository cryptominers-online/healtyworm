...
---------------
HealthyWormCoin is a HealthyWormCoin network-compatible, community-developed wallet client.

The project has been designed to provide people with a
stable, secure, and feature-rich alternative to the HealthyWormCoin reference
wallet (http://github.com/HealthyWormCoin/HealthyWormCoin). 

To help faciliate broad community cooperation, a number of trusted 
HealthyWormCoin/Peershares community leaders have write permissions to the project's 
...
Resources
---------
HealthyWormCoin source code: https://github.com/HealthyWormCoin/HealthyWormCoin

For the most current instructions covering how to compile HealthyWormCoin from 
source on a variety of operating systems, please visit:
https://github.com/HealthyWormCoin/HealthyWormCoin/tree/master/doc

Open software issues can be viewed, and new issues can be reported at:
https://github.com/HealthyWormCoin/HealthyWormCoin/issues?state=open

HealthyWormCoin discussion forums (hosted by HealthyWormCoinTalk.org): 
http://www.HealthyWormCointalk.org/index.php?board=64.0



Acknowledgements
----------------
HealthyWormCoin owes it's existance to the time and effort put forth by
the developers and supporters of the following projects:


	HealthyWormCoin (HealthyWormCoin) 0.4.0 BETA
	Copyright (c) 2011-2014 Bitcoin Developers

	Distributed under the MIT/X11 software license
	(http://www.opensource.org/licenses/mit-license.php)

	HealthyWormCoin is a free open source project with the goal of providing a 
	...
	http://github.com/HealthyWormCoin/HealthyWormCoin
